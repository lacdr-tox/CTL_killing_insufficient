...
## R1 updated to handle mixed tumour el4 eg7 data

library(zoo)
## set target

inputDir <- "C:/Users/richard/Documents/PhD/Submission/Rev1/data/stats/"
outputDir <- "C:/Users/richard/Documents/PhD/Submission/Rev1/data/processedStats/"
...
getStats <- function(i,mylist){
  ...
  eg7 <-  sapply(mylist, function(x) abs(x$eg7[i]))
  ...
  out <- c(time,volS,tcellsS,conS,deathsS,radS,confracS,realisedS,measuredS,eg7S)
  names(out)<-c("time",
